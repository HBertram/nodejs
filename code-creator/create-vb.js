...
Public Class C${upperTable}ServiceBase
    ...
    Public Overridable Function WAdd${upperTable}(ByVal o${upperTable} As C${upperTable}) As String
        If HasPermit("add_${name}") = False Then
    ...
    Public Overridable Function WSearch${upperTable}s(dicParam As Dictionary(Of String, Object), strOrder As String, ByVal iPageNum As Integer, ByVal iPageSize As Integer) As String
        ...
        Dim o As C${upperTable} = (New C${upperTable})
    ...
    Public Overridable Function Get${upperTable}sByPage(ByVal iPageNum As Integer, ByVal iPageSize As Integer, _
        ...
        Dim o${upperTable} As C${upperTable} = New C${upperTable}
          If HasPermit("delete_${name}") Then
              oPageQueryResult.m_iCanDelete = 1
          End If
          If HasPermit("add_${name}") Then
              oPageQueryResult.m_iCanAdd = 1
          End If
          If HasPermit("update_${name}") Then
    ...
    Public Overridable Function BatchDelete${upperTable}s(ByVal ids As String) As String
        If HasPermit("delete_${name}") = False Then
            Return MesCommonLib.COMMONERROR("没有权限")
        End If
    ...
    Protected Overridable Function Search${upperTable}sByPage(ByVal strWhere As String, strOrder As String, ByVal iPageNum As Integer, _
        ...
        If HasPermit("list_${name}") = False Then
            Return False
        End If
